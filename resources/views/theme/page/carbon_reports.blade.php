                    ...
                    <div id="wizard_container">
                        ...
                        <form action="{{route('SubmitForm')}}" id="survey_form" method="post" >
                         ...
                         <img src="{{asset('assets/img/favpng.png')}}" width="450" height="450" alt="">
                            ...
                            <div >
                                @if($total>=0)
                                <button type="button" name="forward" class="forward">KARBON AYAK İZİ RAPORU </button>
                                    @else
                                    <button type="button" name="dsa" class="forward">KARBON AYAK İZİ SERTİFİKASI </button>
                                @endif
                            </div>
...
<script>
    ...
    raporButonu.addEventListener('click', function() {
        var endpoint = @if($total>=0) '/generatePdf' @else '/CertificatePdf' @endif;
